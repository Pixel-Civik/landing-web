...
const UseCases = () => {
  return (
    <section className="py-24 bg-slate-900 border-b border-white/5 relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="absolute inset-0 z-20 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
               {/* Box 1 */}
               <div className="absolute top-[20%] left-[30%] w-[20%] h-[30%] border-[2px] border-[var(--color-neon-teal)] bg-[var(--color-neon-teal)]/10">
                 <div className="absolute -top-6 left-[-2px] bg-[var(--color-neon-teal)] text-slate-900 text-xs font-bold px-2 py-1">Persona 98%</div>
               </div>
               {/* Box 2 */}
               <div className="absolute top-[40%] left-[60%] w-[15%] h-[40%] border-[2px] border-blue-400 bg-blue-400/10">
                 <div className="absolute -top-6 left-[-2px] bg-blue-400 text-white text-xs font-bold px-2 py-1">Objeto 92%</div>
               </div>
            </div>

            {/* Content Overlay */}
            <div className="absolute inset-0 z-30 flex flex-col justify-end p-8 bg-gradient-to-t from-slate-900/70 via-slate-900/20 to-transparent">
              ...
              <div className="flex items-center gap-4">
                <a href="https://wa.me/51958797691?text=Hola%2C%20me%20interesa%20Pixel%20Civik%20para%20Retail" target="_blank" rel="noopener noreferrer" className="text-[var(--color-neon-teal)] font-semibold flex items-center gap-2 hover:text-[var(--color-neon-teal)]/80 transition-colors group/btn">
                ...
                <a href="mailto:contacto@pixelcivik.com?subject=Consulta%20Retail%20-%20Pixel%20Civik" className="text-[var(--color-neon-teal)] font-semibold flex items-center gap-2 hover:text-[var(--color-neon-teal)]/80 transition-colors group/btn">
          ...
          >
            ...
            <div className="absolute inset-0 z-30 flex flex-col justify-end p-8 bg-gradient-to-t from-slate-900/70 via-slate-900/20 to-transparent">
              ...
              <div className="flex items-center gap-4">
                <a href="https://wa.me/51958797691?text=Hola%2C%20me%20interesa%20Pixel%20Civik%20para%20Seguros" target="_blank" rel="noopener noreferrer" className="text-blue-400 font-semibold flex items-center gap-2 hover:text-blue-300 transition-colors group/btn">
                  <MessageCircle className="w-4 h-4" /> WhatsApp <span className="group-hover/btn:translate-x-1 transition-transform inline-block">→</span>
                </a>
                <a href="mailto:contacto@pixelcivik.com?subject=Consulta%20Seguros%20-%20Pixel%20Civik" className="text-blue-400 font-semibold flex items-center gap-2 hover:text-blue-300 transition-colors group/btn">
                  <Mail className="w-4 h-4" /> Email <span className="group-hover/btn:translate-x-1 transition-transform inline-block">→</span>
                </a>
              </div>
            </div>
